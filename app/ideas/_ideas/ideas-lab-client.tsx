...
// =============================================================================
// isaacpaha.com — Ideas Lab Client
// app/ideas/_ideas/ideas-lab-client.tsx
// =============================================================================

import React, { useState, useMemo } from "react";
import type { DBIdea, IdeaCategory, IdeaStatus } from "@/lib/types/idea";
import { parseIdeaTags } from "@/lib/types/idea";
...
export const IdeasLabClient = ({
  ...
  const filtered = useMemo(() => {
    return ideas.filter((idea) => {
      ...
      // Hide featured from grid only when browsing without filters
      const notFeaturedHidden =
        hasFilters || !idea.isFeatured;

      return matchesSearch && matchesCategory && matchesStatus && notFeaturedHidden;
    });
  }, [ideas, search, activeCategory, activeStatus, hasFilters]);

  return (
    <div className="min-h-screen bg-gray-950 text-white">
      {/* Hero — stats from DB */}
      <IdeasHero stats={stats} />
