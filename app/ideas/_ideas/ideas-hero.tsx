...
// =============================================================================
// isaacpaha.com — Ideas Hero
// app/ideas/_ideas/ideas-hero.tsx
// =============================================================================
...
export const IdeasHero = ({ stats }: IdeasHeroProps) => {
  const STATS = [
    { icon: Lightbulb,    value: stats.total.toString(),                               label: "Ideas Published"  },
    { icon: FlaskConical, value: stats.developing.toString(),                          label: "In Development"   },
    { icon: Zap,          value: stats.launched.toString(),                            label: "Launched"         },
    { icon: TrendingUp,   value: `${(stats.totalViews / 1000).toFixed(1)}k`,          label: "Total Views"      },
  ];
        ...
        >
          ...
          >
            {STATS.map(({ icon: Icon, value, label }) => (
              <div key={label} className="bg-gray-900 px-6 py-5 flex flex-col gap-1">
