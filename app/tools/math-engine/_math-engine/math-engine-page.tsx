...
export function MathEnginePage({ isSignedIn, tool, relatedTools }: MathEnginePageProps) {
                ...
                {isSignedIn
                  ...
                  : (
                    <div className="flex flex-col items-center justify-center py-20 text-center bg-gray-50 border border-gray-100 rounded-xs">
                      ...
                      <Link href="/sign-in?redirect_url=/tools/math-engine"
            ...
            {activeTab === "guide" && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-0">
                ...
                {HOW_IT_WORKS.map((s, i) => (
                  <div key={s.step} className="flex gap-6 pb-10 relative">
                    ...
                    <div className="w-10 h-10 rounded-xs font-black text-sm flex items-center justify-center flex-shrink-0 relative z-10"
                      style={{ backgroundColor: `${ACCENT}12`, color: ACCENT }}>{s.step}</div>
                    <div>
                ...
                <div className="mt-4 border rounded-xs p-6" style={{ backgroundColor: `${ACCENT}06`, borderColor: `${ACCENT}20` }}>
                  <h3 className="text-base font-bold mb-3" style={{ color: ACCENT }}>💡 How to get the most out of it</h3>
