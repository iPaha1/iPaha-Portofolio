...
function AICoach({ apps, isSignedIn }: { apps: JobApplication[]; isSignedIn: boolean }) {
  ...
  return (
    <div className="bg-white min-h-[600px]" style={{fontFamily:"Sora,sans-serif"}}>
      ...
      <div className="p-5">
        ...
        {/* ── AI COACH TAB ─────────────────────────────────────────────── */}
        {tab === "ai" && <AICoach apps={apps} isSignedIn={!!isSignedIn} />}
...
export { JobApplicationTracker as JobApplicationTrackerTool };