...
import { CVAnalyzerTool } from "../../_tools/cv-analyzer";
...
import { NormalisedTool } from "../../_tools/tools-lab-client";
...
const ReadingProgress = ({ accentColor }: { accentColor: string }) => {
...
export const ToolDetailClient = ({ isSignedIn, tool, relatedTools }: ToolDetailClientProps) => {
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    value:
                      tool.ratingCount > 0
                        ? `${tool.ratingAvg.toFixed(1)}/5 (${tool.ratingCount} reviews)`
                        : "No reviews yet",
              ...
              >
                ...
                <div className="flex items-start gap-3 mt-5 bg-amber-50 border border-amber-100 rounded-xs px-4 py-3.5">
                  ...
                  <p className="text-xs text-amber-800 leading-relaxed">
                    This tool is powered by AI. Results are generated in real time and
          ...
          <div className="mt-20 pt-12 border-t border-gray-100">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-black text-gray-900">
                More{" "}
                <span style={{ color: catCfg.color }}>{tool.category}</span>{" "}
                tools
              </h2>
              <Link
                href="/tools"
