...
function ReadingProgress({ accentColor }: { accentColor: string }) {
  ...
  return <div className="fixed top-0 left-0 right-0 z-50 h-0.5"><div className="h-full transition-[width] duration-100" style={{ width: `${width}%`, backgroundColor: accentColor }} /></div>;
}
...
export function QRGeneratorPage({ isSignedIn, tool, relatedTools }: QRGeneratorPageProps) {
  ...
  const TABS = [
    ...
    ...(isSignedIn ? [{ id: "workspace", label: "My QR Codes", icon: TrendingUp } as const] : []),
          ...
          <div className="hidden lg:block">
            {isSignedIn ? (
              <div className="rounded-xs p-5 border"
                ...
                <p className="text-sm mb-4 leading-relaxed" style={{ color: `${tool.accentColor}cc` }}>
              ...
              <div className="bg-gray-50 border border-gray-100 rounded-xs p-5">
                ...
                <Link href="/sign-in?redirect_url=/tools/qr-code-generator"
