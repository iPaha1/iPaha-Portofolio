              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <div className="flex items-start gap-3 mt-5 bg-amber-50 border border-amber-100 rounded-xs px-4 py-3.5">
                  ...
                  <p className="text-xs text-amber-800 leading-relaxed">
                    Your CV is analysed locally and not stored permanently. Analyses are powered by Claude AI. Results reflect AI assessment — always apply your own judgment.
                  </p>
                </div>
              </motion.div>
            )}
                ...
                {isSignedIn
                  ...
                  : (
                    <div className="flex flex-col items-center justify-center py-20 text-center bg-gray-50 border border-gray-100 rounded-xs">
                      ...
                      <a href="/sign-in?redirect_url=/tools/ai-cv-analyser"
