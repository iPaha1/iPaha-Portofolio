...
// app/api/tools/shopping/lists/[listId]/route.ts
...
export async function GET(_req: NextRequest, { params }: Params) {
  try {
    ...
    console.error("[shopping/lists/id] GET error:", err);
    return NextResponse.json(
      { error: err.message ?? "Failed to fetch list" },
      { status: 500 }
    );
  }
}
...
export async function PATCH(req: NextRequest, { params }: Params) {
  try {
    ...
    console.log(`[shopping/lists/id] Updated list ${listId}`);
    
    return NextResponse.json({ ok: true, list: updated });
  } catch (err: any) {
    console.error("[shopping/lists/id] PATCH error:", err);
    return NextResponse.json(
      { error: err.message ?? "Failed to update list" },
      { status: 500 }
    );
  }
}
...
export async function DELETE(_req: NextRequest, { params }: Params) {
  try {
    ...
    console.log(`[shopping/lists/id] Deleted list ${listId}`);
    
    return NextResponse.json({ ok: true });
  } catch (err: any) {
    console.error("[shopping/lists/id] DELETE error:", err);
    return NextResponse.json(
