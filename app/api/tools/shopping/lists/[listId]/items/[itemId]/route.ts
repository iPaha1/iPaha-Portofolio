...
// app/api/tools/shopping/lists/[listId]/items/[itemId]/route.ts
...
export async function PATCH(req: NextRequest, { params }: Params) {
  try {
    const { listId: listId, itemId } = await params;
    ...
    console.log(`[shopping/item] Updated item ${itemId} in list ${listId}`);
    
    return NextResponse.json({ ok: true, item: updated });
  } catch (err: any) {
    console.error("[shopping/item] PATCH error:", err);
...
export async function DELETE(_req: NextRequest, { params }: Params) {
  try {
    ...
    console.log(`[shopping/item] Deleted item ${itemId} from list ${listId}`);
    
    return NextResponse.json({ ok: true });
  } catch (err: any) {
    console.error("[shopping/item] DELETE error:", err);
    return NextResponse.json(
