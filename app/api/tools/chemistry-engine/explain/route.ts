...
// // =============================================================================
// // isaacpaha.com — Chemistry Understanding Engine — Explanation API
// // app/api/tools/chemistry-engine/explain/route.ts
// //
// // POST { question, level, mode, explorerMode }
// //   level:       "gcse" | "alevel" | "university"
// //   mode:        "full" | "simpler" | "deeper" | "tutor"
// //   explorerMode: true for Theory Explorer (broad topics)
// //
// // Returns 10-layer structured chemistry breakdown:
// //   1. simpleDefinition    — plain English
// //   2. particleLevel       — what atoms/electrons/bonds are doing (THE differentiator)
// //   3. corePrinciple       — the law/equation with every term explained
// //   4. whyItExists         — the motivation behind the concept
// //   5. history             — discovery, key chemists, era
// //   6. theoryExplainer     — the underpinning theory (atomic, bonding, collision, etc.)
// //   7. realWorld           — applications across medicine, industry, environment
// //   8. intuition           — mental models and analogies
// //   9. misconceptions      — common wrong beliefs corrected
// //  10. experiments         — "try it yourself" with safe, accessible activities
// //   + conceptLinks, visualisation, whyItMatters, levelSummary, examTips
// // =============================================================================
