...
// =============================================================================
// isaacpaha.com — Blog Card
// app/blog/_blog/blog-card.tsx
// =============================================================================
...
import type { DBPost } from "@/lib/types/blog";
import { parseTags, formatPostDate } from "@/lib/types/blog";
      ...
      <motion.div variants={staggerItem}>
        ...
        >
          <div
            ...
            style={{ backgroundColor: `${post.coverColor ?? "#f59e0b"}12` }}
          >
            {post.coverEmoji}
          </div>
  ...
  if (variant === "horizontal") {
    return (
      <motion.div variants={staggerItem}>
        <Link
          href={`/blog/${post.slug}`}
          className="group flex gap-5 p-5 bg-white border border-gray-100 rounded-xs hover:border-amber-200 hover:shadow-md hover:shadow-amber-50 transition-all duration-300"
        >
          {/* Cover swatch */}
          <div
            ...
            style={{ backgroundColor: `${post.coverColor ?? "#f59e0b"}10` }}
          >
            <div
              className="absolute inset-0 opacity-20"
              style={{
                backgroundImage: `radial-gradient(circle at 2px 2px, ${post.coverColor ?? "#f59e0b"}50 1px, transparent 0)`,
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 text-xs text-gray-400">
              ...
              <span className="ml-auto">{formatPostDate(post.publishedAt ?? null)}</span>
            </div>
          </div>
        </Link>
      </motion.div>
        ...
        >
          ...
          >
            <div
              ...
              style={{
                backgroundImage: `radial-gradient(circle at 2px 2px, ${post.coverColor ?? "#f59e0b"}60 1px, transparent 0)`,
            ...
            {seriesTitle && (
              <div className="absolute bottom-3 left-3 text-[9px] font-bold text-gray-600 bg-white/80 backdrop-blur-sm px-2 py-1 rounded-xs border border-gray-200">
                {seriesTitle} · Part {post.seriesPart}
              </div>
            )}
          </div>
