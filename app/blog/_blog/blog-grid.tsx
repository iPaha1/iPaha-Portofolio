...
// =============================================================================
// isaacpaha.com — Blog Grid
// app/blog/_blog/blog-grid.tsx
// =============================================================================
...
export const BlogGrid = ({ posts }: BlogGridProps) => {
  ...
  // Editorial layout: first post large, second default, rest in 2-col grid
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* Rest: 2-column grid, every 5th as horizontal */}
        {rest.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {rest.map((post, i) => (
              <BlogCard
